            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-4 row">
                            <label for="mypsw" class="col-md-4 col-form-label text-md-right">{{ __('Password') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="validatePassword" class="d-none">
                                    <p id="myletter" class="text-danger">A lowercase letter</p>
                                    <p id="mycapital" class="text-danger">A capital (uppercase) letter</p>
                                    <p id="mynumber" class="text-danger">A number</p>
                                    <p id="mylength" class="text-danger">Minimum 8 characters</p>
                                  </div>
                                @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
...
{{-- ------------------------------------- NUOVO FORM --}}
                        ...
                        <div class="mb-4 row">
                            <label for="inputNumber" class="col-md-4 col-form-label text-md-right">Number <span class="text-danger">*</span></label>
