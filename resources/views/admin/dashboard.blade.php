                            ...
                            <tr class="align-middle">
                                ...
                                <td>
                                    <div class="w-75 m-auto">
                                        ...
                                        <a href="{{ route('products.show', $product) }}" class="btn btn-dark my-1 w-100">Show</a>
                                        <a href="{{ route('products.edit', $product) }}" class="btn btn-primary my-1 w-100">Edit</a>
                                        <form action="{{ route('products.destroy', $product) }}" method="POST"
                                        style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger btn-delete my-1 w-100" data-product-name="{{$product->name}}">Delete</button>
                                    </div>
                                    </form>
                                </td>
                            </tr>
